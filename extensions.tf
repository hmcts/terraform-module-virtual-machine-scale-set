...
module "vm-bootstrap" {
  ...
  virtual_machine_scale_set_id = lower(var.vm_type) == "linux" ? azurerm_linux_virtual_machine_scale_set.linux_scale_set[0].id : azurerm_windows_virtual_machine_scale_set.windows_scale_set[0].id
